...
type ColumnDescription struct {
	...
	ColumnType    GoColumnType // represents a basic go type
	...
	IsUnique              bool
	IsTimestamp 		  bool // This field is a Timestamp
	IsAutoUpdateTimestamp bool // Database is auto updating this timestamp, otherwise we will do it manually
	Comment               string
...
// Return the GoColumnType corresponding to the given field offset
