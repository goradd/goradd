 ...
 *  g$(this).parent().attr('id') or g$(this).parent()[0].id - the id of the row clicked on
 *  g$(this).parent().data("value") - the "data-value" attribute of the row. Use this formula for any kind of "data-" attribute.
 *  g$(this).parent().closest('table').find('thead').find('th')[this.cellIndex].id - the id of the table clicked in
...
func (e *CellClickEvent) RowDataActionValue(key string) *CellClickEvent {
	e.ActionValue(javascript.JsCode(`g$(this).parent().data("` + key + `")`))
	return e
}
...
func (e *CellClickEvent) CellDataActionValue(key string) *CellClickEvent {
	e.ActionValue(javascript.JsCode(`g$(this).data("` + key + `")`))
	return e
}
