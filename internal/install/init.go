...
// This code is here simply to help the goradd tool find the install directory.
...
var InstallFolderLocation string

func init() {
	_, filename, _, _ := runtime.Caller(0)
	InstallFolderLocation = filepath.Dir(filename)
}
