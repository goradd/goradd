...
INSERT INTO `two_key` (`server`, `directory`, `file_name`)
VALUES (''cnn.com'', ''us'', ''news''),
       (''google.com'', ''drive'', ''''),
...
INSERT INTO `type_test` (`id`, `date`, `time`, `date_time`, `ts`, `test_int`, `test_float`, `test_double`, `test_text`,
                         `test_bit`, `test_varchar`, `test_blob`)
VALUES (1, ''2019 - 01 - 02 '', ''06:17:28'', ''2019 - 01 - 02 06:17:28'', ''2019 - 01 - 23 08:52:06'', 5, 1.2, 3.33,
        ''Sample'', 1, ''Sample'', 0x61626364);
