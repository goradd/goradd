...
// Milestone is a code generated ORM structure that accesses the milestone table in the database.
//
// To insert a new Milestone in the database, call NewMilestone, followed by Save().
//
//	o := NewMilestone()
//	o.Save()
//
// To get a Milestone object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryMilestone to use a builder pattern to build
// and execute query.
...
func (o *Milestone) load(m map[string]interface{}, objThis *Milestone, objParent interface{}, parentKey string) {
...
func (o *Milestone) getModifiedFields() (fields map[string]interface{}) {
...
func (o *Milestone) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.projectIDIsValid {
...
func (o *Milestone) resetDirtyStatus() {
	o.idIsDirty = false
	o.projectIDIsDirty = false
	o.nameIsDirty = false
