...
// Project is a code generated ORM structure that accesses the project table in the database.
//
// To insert a new Project in the database, call NewProject, followed by Save().
//
//	o := NewProject()
//	o.Save()
//
// To get a Project object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryProject to use a builder pattern to build
// and execute query.
type Project struct {
	id        string
	idIsValid bool
...
func (o *Project) StatusType() ProjectStatusType {
...
func (o *Project) SetStatusType(v ProjectStatusType) {
...
func (o *Project) load(m map[string]interface{}, objThis *Project, objParent interface{}, parentKey string) {
...
func (o *Project) getModifiedFields() (fields map[string]interface{}) {
...
func (o *Project) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.numIsValid {
...
func (o *Project) resetDirtyStatus() {
	o.idIsDirty = false
	o.numIsDirty = false
	o.statusTypeIDIsDirty = false
	o.managerIDIsDirty = false
