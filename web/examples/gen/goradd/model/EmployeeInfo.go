...
// EmployeeInfo is a code generated ORM structure that accesses the employee_info table in the database.
//
// To insert a new EmployeeInfo in the database, call NewEmployeeInfo, followed by Save().
//
//	o := NewEmployeeInfo()
//	o.Save()
//
// To get a EmployeeInfo object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryEmployeeInfo to use a builder pattern to build
// and execute query.
...
func (o *EmployeeInfo) load(m map[string]interface{}, objThis *EmployeeInfo, objParent interface{}, parentKey string) {
...
func (o *EmployeeInfo) update(ctx context.Context) {
...
func (o *EmployeeInfo) insert(ctx context.Context) {
	d := Database()
	db.ExecuteTransaction(ctx, d, func() {
		if o.oPerson != nil {
			o.oPerson.Save(ctx)
...
func (o *EmployeeInfo) getModifiedFields() (fields map[string]interface{}) {
...
func (o *EmployeeInfo) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.personIDIsValid {
...
func (o *EmployeeInfo) resetDirtyStatus() {
	o.idIsDirty = false
	o.personIDIsDirty = false
	o.employeeNumberIsDirty = false
