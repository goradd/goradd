...
// Address is a code generated ORM structure that accesses the address table in the database.
//
// To insert a new Address in the database, call NewAddress, followed by Save().
//
//	o := NewAddress()
//	o.Save()
//
// To get a Address object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryAddress to use a builder pattern to build
// and execute query.
type Address struct {
	id        string
	idIsValid bool
...
func (o *Address) load(m map[string]interface{}, objThis *Address, objParent interface{}, parentKey string) {
...
func (o *Address) getModifiedFields() (fields map[string]interface{}) {
...
func (o *Address) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.personIDIsValid {
...
func (o *Address) resetDirtyStatus() {
	o.idIsDirty = false
	o.personIDIsDirty = false
	o.streetIsDirty = false
	o.cityIsDirty = false
