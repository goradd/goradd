...
// Gift is a code generated ORM structure that accesses the gift table in the database.
//
// To insert a new Gift in the database, call NewGift, followed by Save().
//
//	o := NewGift()
//	o.Save()
//
// To get a Gift object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryGift to use a builder pattern to build
// and execute query.
type Gift struct {
	number        int
	numberIsValid bool
...
func (o *Gift) load(m map[string]interface{}, objThis *Gift, objParent interface{}, parentKey string) {
...
func (o *Gift) update(ctx context.Context) {
...
func (o *Gift) insert(ctx context.Context) {
	d := Database()
	db.ExecuteTransaction(ctx, d, func() {
...
func (o *Gift) getModifiedFields() (fields map[string]interface{}) {
...
func (o *Gift) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.numberIsValid {
