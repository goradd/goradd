...
// Person is a code generated ORM structure that accesses the person table in the database.
//
// To insert a new Person in the database, call NewPerson, followed by Save().
//
//	o := NewPerson()
//	o.Save()
//
// To get a Person object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryPerson to use a builder pattern to build
// and execute query.
type Person struct {
	id        string
	idIsValid bool
...
func (o *Person) load(m map[string]interface{}, objThis *Person, objParent interface{}, parentKey string) {
...
func (o *Person) getModifiedFields() (fields map[string]interface{}) {
...
func (o *Person) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.firstNameIsValid {
...
func (o *Person) resetDirtyStatus() {
	o.idIsDirty = false
	o.firstNameIsDirty = false
	o.lastNameIsDirty = false
	o.oAddressesIsDirty = false
