...
// Login is a code generated ORM structure that accesses the login table in the database.
//
// To insert a new Login in the database, call NewLogin, followed by Save().
//
//	o := NewLogin()
//	o.Save()
//
// To get a Login object from the database, call one of the Load* methods to get an object by
// its primary key or one of its indexes, or call QueryLogin to use a builder pattern to build
// and execute query.
type Login struct {
	id        string
	idIsValid bool
...
func (o *Login) load(m map[string]interface{}, objThis *Login, objParent interface{}, parentKey string) {
...
func (o *Login) getModifiedFields() (fields map[string]interface{}) {
...
func (o *Login) getValidFields() (fields map[string]interface{}) {
	fields = map[string]interface{}{}
	if o.personIDIsValid {
