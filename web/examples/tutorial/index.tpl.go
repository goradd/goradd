...
`); err != nil {
	...
	if `` == "" {
		...
		if err = ctrl.Page().GetControl("viewSourceButton").Draw(ctx, _w); err != nil {
			return
		}
...
`); err != nil {
		...
		if err = ctrl.Page().GetControl("viewSourceButton").ProcessAttributeString(``).Draw(ctx, _w); err != nil {
			return
		}
