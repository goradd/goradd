...
<p>
    ...
    <li>Delete this record as well</li>
    </ol>
    Goradd will look at whether the foreign key is allowed to be NULL to determine which to do.
    If the foreign key can be NULL, then it will be set the foreign key to NULL when the record on the other side of the relationship is deleted.
    Otherwise, it will also delete the record with the foreign key. You can override this behavior, but that is what happens by default.
</p>
