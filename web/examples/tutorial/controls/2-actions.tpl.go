...
<p>
Callback actions invoke the control.Action() that is in every GoRADD control. You specify the id
of the control that will receive the action, and your own integer id that is sent to the Action() function,
...
created and how the Action() function responds.
Note that the Action() function just sets the text of the span and the span is automatically redrawn
