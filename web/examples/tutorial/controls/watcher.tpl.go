...
`)
	...
	buf.WriteString(`<p>Different databases refer to data objects using different words, but the concepts are the same. For example,
...
`)
	...
	buf.WriteString(`<p>For example, if a &#34;project&#34; object wanted easy access to the &#34;person&#34; object that is the manager of the project,
...
<p>If you have not yet set up the example database, do that now using the following steps.
</p>
`)
