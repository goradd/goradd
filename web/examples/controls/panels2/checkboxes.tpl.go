...
func (control *panels.CheckboxPanel) DrawTemplate(ctx context.Context, buf *bytes.Buffer) (err error) {
...
with input elments like textboxes and select lists. What if you want both a title, and a checkbox
